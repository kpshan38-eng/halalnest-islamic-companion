      ...
      <div className="container mx-auto px-4 max-w-md">
        ...
        <div className="mt-8 p-4 bg-secondary/10 border border-secondary/20 rounded-xl text-center">
          <p className="text-sm text-muted-foreground">
            <strong className="text-secondary">Note:</strong> To enable full functionality including user authentication, 
            database storage, and community features, this app needs to be connected to Supabase.
          </p>
        </div>
      </div>
    </main>
